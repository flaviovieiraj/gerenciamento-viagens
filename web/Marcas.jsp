                ...
                <tr>
                    ...
                    <td>
                        <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                            ...
                            <button type="button" class="btn btn-warning" onclick="window.location.href = 'MarcaServlet?cod=${marca.codigo}&op=alterar'">alterar</button>
                            <button type="button" class="btn btn-danger" onclick="window.location.href = 'MarcaServlet?cod=${marca.codigo}&op=deletar'">deletar</button>
                        </div>
                    </td>
                </tr>
            </c:forEach>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-body">
                        <%@include file="/Cadastros/CadastroMarca.jsp" %>
                    </div>
                </div>
            </div>
        </div>
